...
double Map::getRoom()
    ...
    void Map::setRoom(double r)
    {
        room = r;
    }
    
    bool Map::getKeyAt(int kIndex)
    {
        return keys[kIndex];
    }
    void Map::setKeyAt(int kIndex, bool k)
    {
        keys[kIndex] = k;
    }

    int Map::getSorcererAnger()
    {
        return sorcererAnger;
    }
    void Map::setSorcererAnger(int s)
    {
        sorcererAnger = s;
    }
    
    string Map::getTreasureAt(int tRow, int tColumn)
    {
        return treasure[tRow][tColumn];
    }
    void Map::setTreasureAt(int tRow, int tColumn, string tName)
    {
